...
void PlanningSceneWrapper::Impl::applyPlanningScene(const moveit_msgs::PlanningScene &scene)
{
    _monitor->updateFrameTransforms();
    _monitor->newPlanningSceneMessage(scene);
}

bool PlanningSceneWrapper::Impl::addCollisionObject(moveit_msgs::CollisionObject co,
