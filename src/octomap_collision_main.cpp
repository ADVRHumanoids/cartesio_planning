...
octomap_msgs::OctomapWithPose generateMessage(octomap_msgs::Octomap inputMap)
{
  ...
  msg2.origin.position.x = 0; msg2.origin.position.y = 0; msg2.origin.position.z = 0;
  msg2.origin.orientation.x = 0; msg2.origin.orientation.y = 0; msg2.origin.orientation.z = 0; msg2.origin.orientation.w = 1;
